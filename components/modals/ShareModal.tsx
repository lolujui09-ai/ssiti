...
import { X, Link2, Code2, Copy, Check, Download, ExternalLink } from 'lucide-react';
...
export const ShareModal = ({
  ...
  const fullShareUrl = `${currentOrigin}/f/${form.id}`;
        ...
        <div className="p-6 space-y-4 text-xs">
          {activeTab === 'link' && (
            <div className="space-y-4">
              <div>
                <label className="font-bold text-slate-800 block mb-1.5">Tautan Formulir Siap Dibagikan:</label>
              ...
              <div className="flex items-center justify-between pt-1">
                ...
                >
                  <span>Buka Form di Tab Baru</span>

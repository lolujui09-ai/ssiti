...
export const BuilderCanvas = ({
  ...
  const handleAddSection = () => {
    ...
    // Update previous section action to jump to this new section or 'next'
  ...
  return (
    <div className="max-w-3xl mx-auto pb-32 relative">
      ...
      <div className="space-y-4">
        {/* ======================================================== */}
        {/* 1. GOOGLE FORMS MAIN HEADER CARD                         */}
        {/* ======================================================== */}
        <div className="bg-white rounded-2xl shadow-xs border border-slate-200/90 overflow-hidden">
          {/* Top Theme Accent Bar (Google Forms signature 10px stripe) */}
          <div
        ...
        {form.sections.map((section, sIdx) => {
          ...
          return (
            <div key={section.id} className="space-y-4">
              {/* Section Header Card (if more than 1 section, or named section) */}
